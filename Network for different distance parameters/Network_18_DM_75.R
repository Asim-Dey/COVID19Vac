...
edge_density(G0, loops=F) # 0.00236921
...
meanD1<-mean(degree1);meanD1 # 7.56015
sdD1<-sd(degree1);sdD1 # 11.11122
...
AVPL<-average.path.length(G0);AVPL # 11.64383
Diameter<-diameter(G0) ;Diameter # 35
...
assortativity_degree(G11) # 0.8804902
