...
k2=53.30   #  1rd Qu. Q1 or above of 18 netowrk for comparison
...
#write.csv(edlist_65_Dist, '~/Library/CloudStorage/OneDrive-Personal/COVID-19 Vac Network/Data and Code/Data/COVID-19 Vaccinations in the US/edlist_65_Dist_d50_Q1.csv')
...
meanD1<-mean(degree1);meanD1 #11.66416
sdD1<-sd(degree1);sdD1 # 7.87914
...
AVPL<-average.path.length(G0);AVPL # 17.61554
...
assortativity_degree(G11)  #  0.9116345

assortativity(G11, V(G11)$vac18, directed=F) #  0.4787897


assortativity_nominal(G11, as.integer(as.factor(V(G11)$state), directed=F)) #  0.7860095


assortativity(G11, V(G11)$Covid_cases, directed=F) # 0.3488102


assortativity(G11, V(G11)$Edu_ass_coll, directed=F) # 0.4866921

assortativity(G11, V(G11)$Income, directed=F) # 0.5671587
